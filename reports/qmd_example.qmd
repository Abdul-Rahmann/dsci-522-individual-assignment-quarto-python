...
![](../results/horse_pops_plot.png){#fig-horse-pops width=80%}
...
![](../results/horse_pops_plot_largest_sd.png){#fig-largest-sd width=80%}

@fig-largest-sd: Horse populations for the province with the largest standard deviation
